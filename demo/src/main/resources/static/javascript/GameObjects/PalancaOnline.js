class PalancaOnline extends Phaser.GameObjects.Sprite{
    constructor(scene,x,y, objectToInteract){
        ...
        this.palancaOnline = scene.add.existing(this)

        this.palancaOnline.setScale(0.4);

        this.palancaOnline.scene.physics.world.enableBody(this);
    ...
    animarPalanca(){
        ...
        if(this.active){
            console.log("SAKTIVO")
            this.palancaOnline.anims.play("palancaAnim", true);
            //this.setAngle(-45)
        }
        else{
