class TutorialLevelOnlineElfo extends Phaser.Scene{
    ...
    this.gnomo = new GnomoOnline(this,   135, 620); //100, 2000 para aparecer abajo izq la elfa aparece en 1970
    this.player = new ElfoOnline(this,  135, 620); //135, 600 en los barriless
