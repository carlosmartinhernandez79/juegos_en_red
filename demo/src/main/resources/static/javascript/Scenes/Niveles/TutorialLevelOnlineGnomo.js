class TutorialLevelOnlineGnomo extends Phaser.Scene{
    ...
    this.player = new GnomoOnline(this,  135, 620); //100, 2000 para aparecer abajo izq la elfa aparece en 1970
    //this.elfo = new ElfoOnline(this,  100, 2000); //135, 600 en los barriless
    this.elfo = new ElfoOnline(this,  135, 620); //135, 600 en los barriless
