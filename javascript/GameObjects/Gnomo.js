class Gnomo extends Phaser.GameObjects.Sprite{
    ...
    move(){
        //-------MOVIMIENTO GNOMO-------
        if (this.wasd.left.isDown && !this.wasd.up.isDown)
        {
        ...
        if (this.wasd.up.isDown && this.canJump)//this.body.touching.down ) //
        {
            ...
            this.canJump = false;
            this.gnomo.anims.play('jump', true);
        }
        ...
        //PREGUNTARLE ESTO
        if (this.wasd.q.isDown && this.gnomo.scale == 0.15)
        {
