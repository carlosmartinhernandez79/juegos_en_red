class TutorialLevel extends Phaser.Scene{
    ...
    create(){
       ...
       // generador.setCollisionByProperty({colision:true});
        ...
        this.anims.create({
            key: 'money_vueltas',
            frames: this.anims.generateFrameNumbers('money', { start: 0, end: 8 }),
            frameRate: 20,
            repeat: -1
        });

        this.misMonedas.create(110,1580,"moneda").anims.play("money_vueltas", true)
        this.misMonedas.create(1000,790,"moneda").anims.play("money_vueltas", true)
        this.misMonedas.create(1000,200,"moneda").anims.play("money_vueltas", true)
